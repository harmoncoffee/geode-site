...
For the `test1/gfprops` specification, if you launch your  system member from `/testDir` in a Unix file system,  looks for the file in this order until it finds the file or exhausts all locations:
