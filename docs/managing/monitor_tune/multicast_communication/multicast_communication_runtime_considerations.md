...
sidebar_label: Run-time Considerations for Multicast
sidebar_position: 4
---
...
The  management and monitoring system is supplemented by a `maxRetransmissionRatio` health
