...
sidebar_label: Controlling Socket Use
sidebar_position: 3
---
...
-   `setThreadsSocketPolicy`. Sets the calling threadâ€™s individual socket policy, overriding the policy set for the application as a whole. If false, the calling thread has its own sockets. If true, the calling thread shares socket connections with other threads.
