...
sidebar_label: How Client/Server Connections Work
sidebar_position: 3
---
...
If an application thread calls an operation that needs a connection and the pool canâ€™t create it, the operation returns a `NoAvailableServersException`.
