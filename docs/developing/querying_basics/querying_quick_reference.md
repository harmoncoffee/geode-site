...
For additional information on  querying, see [Querying](../developing/querying_basics/chapter_overview.html).

-   [How do I write and execute a query against a  region?](querying_quick_reference.html#reference_D5CE64F5FD6F4A808AEFB748C867189E__section_7A4D2C6A4E2C4F4384C158FFCA9CA1C0)
...
-   [Which query language elements are supported in ?](querying_quick_reference.html#reference_D5CE64F5FD6F4A808AEFB748C867189E__section_FBC59A5420FD40D6907A302A1D50DF7E)
...
To write and execute a query in , you can use any of the following mechanisms. Sample query code follows.
...
In the following examples, the status field is type String and the ID field is type int. See [Supported Literals](../developing/query_additional/literals.html#literals) for a complete list of literals supported in  querying.
...
When the query is executed,  will log a message in `$GEMFIRE_DIR/system.log` with the following information:
