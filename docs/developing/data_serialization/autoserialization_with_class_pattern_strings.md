...
Use class pattern strings to name the classes that you want to serialize using 's reflection-based autoserializer and to specify object identity fields and to specify fields to exclude from serialization.
