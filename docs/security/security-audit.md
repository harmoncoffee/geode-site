...
See [Firewalls and Ports](../configuring/running/firewalls_ports.html#concept_5ED182BDBFFA4FAB89E3B81366EBC58E) for the complete list of ports used by , their default values, and how to configure them if you do not want to use the default value.

 does not have any external interfaces or services that need to be enabled or opened.
...
For  members (locators and cache servers), you can also specify a custom working directory location when you start each process. See [Logging](../managing/logging/logging.html#concept_30DB86B12B454E168B80BB5A71268865) for more details.
