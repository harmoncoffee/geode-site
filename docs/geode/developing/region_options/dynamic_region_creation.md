...
For a complete discussion of using @@product_name@@ functions, see [Function Execution](../function_exec/chapter_overview). Functions use the `org.apache.geode.cache.execute.FunctionService` class.
