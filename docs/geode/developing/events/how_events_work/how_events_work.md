...
Members in your @@product_name@@ cluster receive cache updates from other members through cache events. The other members can be peers to the member, clients or servers or other clusters.

## Events Features {#how_events_work__section_6C75098DDBB84944ADE57F2088330D5A}
These are the primary features of @@product_name@@ events:
...
## Types of Events {#how_events_work__section_F5F0E506652940DFBA0D6B7AAA72E3EF}
...
Because @@product_name@@ maintains the order of administrative events and the order of cache events separately, using cache events and administrative events in a single process can cause unexpected results.

## Event Cycle {#how_events_work__section_4BCDB22AB927478EBF1035B0DE230DD3}
...
## Event Objects {#how_events_work__section_E48ECC8A1B39411AA23D17BA0C05517E}
...
## Event Distribution {#how_events_work__section_2EA59E9F7203433A8AD248C499D61BF4}
...
## Event Handlers and Region Data Storage {#how_events_work__section_C18D3CA923FB427AA01DD811589D63C0}
...
## Multiple Listeners {#how_events_work__section_22EB4B9E6C4445F898DB64A769780460}
...
## Event Ordering {#how_events_work__section_C4758D7E2CA2498A87315DE903A07AE4}
