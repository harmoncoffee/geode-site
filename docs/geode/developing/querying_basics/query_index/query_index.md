...
The @@product_name@@ query engine supports indexing. An index can provide significant performance gains for query execution.
## {#indexing__section_565C080FBDD0443C8504DF372E3C32C8}
...
-   **[Tips and Guidelines on Using Indexes](indexing_guidelines)**
...
-   **[Creating, Listing and Removing Indexes](creating_an_index)**
...
-   **[Creating Key Indexes](creating_key_indexes)**
...
-   **[Creating Hash Indexes](creating_hash_indexes)**

    **Hash indexes are deprecated.** @@product_name@@ supports the creation of hash indexes for the purposes of performing equality-based queries.

-   **[Creating Indexes on Map Fields ("Map Indexes")](creating_map_indexes)**
...
-   **[Creating Multiple Indexes at Once](create_multiple_indexes)**
...
-   **[Maintaining Indexes (Synchronously or Asynchronously) and Index Storage](maintaining_indexes)**
...
-   **[Using Query Index Hints](query_index_hints)**

    You can use the hint keyword to allow @@product_name@@'s query engine to prefer certain indexes.

-   **[Using Indexes on Single Region Queries](indexes_on_single_region_queries)**
...
-   **[Using Indexes with Equi-Join Queries](using_indexes_with_equijoin_queries)**

    Equi-join queries are queries in which two regions are joined through an equality condition in the WHERE clause.

-   **[Using Indexes with Overflow Regions](indexes_with_overflow_regions)**

    You can use indexes when querying on overflow regions; however, there are caveats.

-   **[Using Indexes on Equi-Join Queries using Multiple Regions](using_indexes_with_equijoin_queries_multiple_regions)**
