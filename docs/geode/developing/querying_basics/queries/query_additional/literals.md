...
## Comparing Values With java.util.Date {#literals__section_BA2D0AC444EB45088F00D9E2C8A1DD06}
...
## Type Conversion {#literals__section_9EE6CFC410D2409188EDEAA43AC85851}
...
## Binary Numeric Promotion {#literals__section_F5A3FC509FD04E09B5468BA94B814701}
...
## Method Invocation Conversion {#literals__section_BA277AC4A9B34C93A5291ECC1FDC11C7}
...
## Temporal Type Conversion {#literals__section_0A1A6EFE98A24538B651373B1C6ED8C0}
...
## Enum Conversion {#literals__section_73255A4630C94D04B461B1480AAF2F66}
Enums are not automatically converted. To use Enum values in query, you must use the toString method of the enum object or use a query bind parameter. See [Enum Objects](../query_select/the_where_clause.md#the_where_clause__section_59E7D64746AE495D942F2F09EF7DB9B5) for more information.

## Query Evaulation of Float.NaN and Double.NaN {#literals__section_CB624C143A2743C5ADC6F95C962F176B}
Float.NaN and Double.NaN are not evaluated as primitives; instead, they are compared in the same manner used as the JDK methods Float.compareTo and Double.compareTo. See [Double.NaN and Float.NaN Comparisons](../query_select/the_where_clause.md#the_where_clause__section_E7206D045BEC4F67A8D2B793922BF213) for more information.
