...
The result of a SELECT statement is either UNDEFINED or is a Collection that implements the [SelectResults](/org/apache/geode/cache/query/SelectResults.html) interface.
