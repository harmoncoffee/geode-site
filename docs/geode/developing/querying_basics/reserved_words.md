...
These words are reserved for the query language and may not be used as identifiers. The words with asterisk (`*`) after them are not currently used by , but are reserved for future implementation.
