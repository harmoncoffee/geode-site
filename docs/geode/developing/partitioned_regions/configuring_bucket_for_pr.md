...
## {#configuring_total_buckets__section_DF52B2BF467F4DB4B8B3D16A79EFCA39}
The total number of buckets for the partitioned region determines the granularity of data storage and thus how evenly the data can be distributed. @@product_name@@ distributes the buckets as evenly as possible across the data stores. The number of buckets is fixed after region creation.
...
## Calculate the Total Number of Buckets for a Partitioned Region {#configuring_total_buckets__section_C956D9BA41C546F89D07DCFE901E539F}
