...
2.  (Optional) If you want to use a disk store that is not the @@product_name@@ default disk store, set the `<pdx>` attribute `disk-store-name` to the name of your non-default disk store.
    **Note:**
