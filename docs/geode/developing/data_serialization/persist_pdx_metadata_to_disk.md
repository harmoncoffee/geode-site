...
-   Understand generally how to configure the  cache. See [Basic Configuration and Programming](../../basic_config/book_intro.html).
-   Understand how  disk stores work. See [Disk Storage](../../managing/disk_storage/chapter_overview.html).
...
2.  (Optional) If you want to use a disk store that is not the  default disk store, set the `<pdx>` attribute `disk-store-name` to the name of your non-default disk store.
    **Note:**
