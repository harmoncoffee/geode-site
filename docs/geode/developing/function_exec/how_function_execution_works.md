...
## Where Functions Are Executed {#how_function_execution_works__section_881D2FF6761B4D689DDB46C650E2A2E1}
...
## How Functions Are Executed {#how_function_execution_works__section_E0C4B7D2E4414F099788A5A441FF0E03}
...
See [Authorization of Function Execution](../../security/implementing_authorization#AuthorizeFcnExecution) for a discussion of this method.
...
## Highly Available Functions {#how_function_execution_works__section_14FF9932C7134C5584A14246BB4D4FF6}
...
## Function Execution Scenarios {#how_function_execution_works__section_A0FD54B73E9A453AA38FC4A4D5282351}
This figure shows the sequence of events for a data-independent function invoked from a client on all available servers.
## {#how_function_execution_works__fig_server_distributed_system}
...
## {#how_function_execution_works__fig_peer_distributed_system}
...
## {#how_function_execution_works__fig_data_dependent_function_region}
...
## {#how_function_execution_works__fig_data_dependent_function_obtaining_current_metadata}
...
## {#how_function_execution_works__fig_data_dependent_function_region_keys}
...
## {#how_function_execution_works__fig_peer_data_dependent_function}
...
## {#how_function_execution_works__fig_client_server_system_target_metadata}
