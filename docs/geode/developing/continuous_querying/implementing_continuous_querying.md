...
Before you begin, you should be familiar with [Querying](../querying_basics/chapter_overview) and have your client/server system configured.
...
2. Write your OQL query to retrieve the data you need from the server.
    ...
    -   The CQ query must be created on a partitioned or replicated region. See [Region Type Restrictions for CQs](how_continuous_querying_works#how_continuous_querying_works__section_bfs_llr_gr).
