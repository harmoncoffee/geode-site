...
-   **[How Disk Stores Work](how_disk_stores_work)**

    Overflow and persistence use disk stores individually or together to store data.

-   **[Disk Store File Names and Extensions](file_names_and_extensions)**
...
-   **[Disk Store Operation Logs](operation_logs)**
...
-   **[Configuring Disk Stores](overview_using_disk_stores)**
...
-   **[Creating Backups for System Recovery and Operational Management](backup_restore_disk_store)**
