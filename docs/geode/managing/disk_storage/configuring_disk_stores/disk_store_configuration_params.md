...
sidebar_label: Disk Store Configuration Parameters
sidebar_position: 2
---
...
**Note:**
The directories must exist when the disk store is created or the system throws an exception. @@product_name@@ does not create directories.
