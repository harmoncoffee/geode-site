...
-   **[Recovering from Crashes with a Peer-to-Peer Configuration](recovering_from_p2p_crashes)**
...
-   **[Recovering from Crashes with a Client/Server Configuration](recovering_from_cs_crashes)**
