...
Before you begin, you should understand @@product_name_long@@ [Basic Configuration and Programming](../../basic_config/book_intro).
...
-   **[Setting Cache Timeouts](performance_controls_setting_cache_timeouts)**
...
-   **[Controlling Socket Use](performance_controls_controlling_socket_use)**

    For peer-to-peer communication, you can manage socket use at the system member level and at the thread level.

-   **[Management of Slow Receivers](performance_controls_managing_slow_receivers)**
...
-   **[Increasing the Ratio of Cache Hits](performance_controls_increasing_cache_hits)**
