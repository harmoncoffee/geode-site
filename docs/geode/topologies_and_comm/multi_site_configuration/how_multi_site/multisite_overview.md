...
-->
## {#topic_70045702D3994BC692E75102CE01BD7C}
...
Gateway senders and receivers are defined at startup in the member caches. A site can use *serial* and/or *parallel* gateway sender configurations, as described in [Gateway Senders](multisite_overview#topic_9AA37B43642D4DE19072CA3367C849BA).
...
## Consistency for WAN Updates {#topic_C74A0961937640B199396DC925D8D782}
...
[Consistency for Region Updates](../../developing/distributed_regions/region_entry_versions#topic_CF2798D3E12647F182C2CEC4A46E2045) describes how Geode ensures consistency within a cluster, in client caches, and when applying updates over a WAN. [Resolving Conflicting Events](../../developing/events/resolving_multisite_conflicts#topic_E97BB68748F14987916CD1A50E4B4542) provides more details about implementing a custom conflict resolver for WAN updates.

## Discovery for Multi-Site Systems {#topic_1742957C8D4B4F7590847EB8DB6CD4F7}
...
## Gateway Senders {#topic_9AA37B43642D4DE19072CA3367C849BA}
...
A gateway sender always communicates with a gateway receiver in a remote cluster. Gateway senders do not communicate directly with other cache server instances. See [Gateway Receivers](multisite_overview#topic_4DB3D9CF01AD4F4899457D1250468D00).

Geode provides two types of gateway sender configurations: *serial* gateway senders and *parallel* gateway senders.

## Serial Gateway Senders {#topic_9AA37B43642D4DE19072CA3367C849BA__section_F7B3A17597B344F19A9E3546097AC5DB}
...
## Parallel Gateway Senders {#topic_9AA37B43642D4DE19072CA3367C849BA__section_5E989CEDC4F147788B393588CFF17106}
...
## Timing of Connections {#GW_sender_connect}
...
## High Availability for Gateway Senders {#topic_9AA37B43642D4DE19072CA3367C849BA__section_70A4D850A5404429AD5CB483D2053F1A}
...
## Stopping Gateway Senders {#topic_9AA37B43642D4DE19072CA3367C849BA__section_aqm_2js_bq}
...
## Pausing Gateway Senders {#topic_9AA37B43642D4DE19072CA3367C849BA__section_hdt_2js_bq}
...
## Gateway Receivers {#topic_4DB3D9CF01AD4F4899457D1250468D00}
...
After you create and start a new gateway receiver at one WAN site, you can execute the [load-balance gateway-sender](../../tools_modules/gfsh/command-pages/load-balance#concept_fn2_qls_5q) command in `gfsh` for existing remote gateway senders so that the new receiver can pick up connections to gateway senders at different sites. You invoke this command on the gateway senders to redistribute connections more evenly among all the gateway receivers. Another option is to use the `GatewaySender.rebalance` Java API.

See [Configure Gateway Receivers](../multi_site_configuration/setting_up_a_multisite_system#setting_up_a_multisite_system__section_E3A44F85359046C7ADD12861D261637B).
