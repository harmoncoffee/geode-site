...
Refer to the [tc Server](http://www.vmware.com/products/vfabric-tcserver) documentation for more information. Once started, @@product_name@@ will automatically launch within the application server process.
...
Information is also logged within the @@product_name@@ log file, which by default is named `gemfire_modules.log`.
