...
**Note:** You cannot override region attributes on the cache server when using the HTTP Session Management Module. You must place all region attribute definitions in the region attributes template that you customize in tc Server. See [Overriding Region Attributes](tc_changing_gf_default_cfg#tc_changing_gf_default_cfg__section_38D803A7E8474188898963F456188543) for more information.

For information on setting up your instance for the most common types of configurations, refer to the sections below. For more information about each interactive prompt, refer to [Interactive Mode Reference](interactive_mode_ref).

## Using a Different Locator Port {#tc_changing_gf_default_cfg__use_a_diff_mc_port}
...
## Overriding Region Attributes {#tc_changing_gf_default_cfg__section_38D803A7E8474188898963F456188543}
...
-   **[Interactive Configuration Reference for the tc Server Module](../../tools_modules/http_session_mgmt/interactive_mode_ref)**
