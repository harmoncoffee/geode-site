...
| [query](command-pages/query.html)                                                      | Run queries against  regions. | online       |
...
| Command                                                                                                                                                                                                                                                 | Description                                                                                                                              | Availability    |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|-----------------|
| [alter disk-store](command-pages/alter.html#topic_99BCAD98BDB5470189662D2F308B68EB)                                                                               | Modify an existing  resource.                                                                          | online          |
...
| [list disk-stores](command-pages/list.html#topic_BC14AD57EA304FB3845766898D01BD04)                                                                              | List all available disk stores in a  cluster.                                                          | online          |
...
| [start pulse](command-pages/start.html#topic_E906BA7D9E7F4C5890FEFA7ECD40DD77) | Launch the  Pulse monitoring dashboard tool in the user's default system browser.                                    | online, offline |
...
## <a id="topic_query_service_commands" class="no-quick-link"></a>Query Service Commands

<a id="topic_query_service_commands_table"></a>
...
| [restore redundancy](command-pages/restore.html)                                                                                                                                     | Restore redundancy to partitioned regions and optionally reassign which members host the primary copies.                                                                                                                       | online       |
| [status redundancy](command-pages/status.html#topic_status_redundancy)                                                                                                                                     | Display the redundancy status of partitioned regions.                                                                                                                             | online       |
