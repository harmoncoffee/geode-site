...
`gfsh` supports the administration, debugging, and deployment of  processes and applications.
...
By default, the cluster configuration service saves the configuration of your  cluster as you create  objects using gfsh. You can export this configuration and import it into another  cluster. See [Overview of the Cluster Configuration Service](../../configuring/cluster_config/gfsh_persist.html#concept_r22_hyw_bl).
