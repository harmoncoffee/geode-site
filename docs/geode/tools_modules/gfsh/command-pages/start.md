...
-   **[start pulse](#topic_E906BA7D9E7F4C5890FEFA7ECD40DD77)**
    ...
    Launch the  Pulse monitoring dashboard tool in the user's default system browser and navigates the user to the landing page (login page).

-   **[start server](#topic_3764EE2DB18B4AE4A625E0354471738A)**

    Start a  cache server process.
...
See [Browsing  MBeans through JConsole](../../../managing/management/mbeans_jconsole.html) for an example of using JConsole with the  management and monitoring system.
...
Connecting by the  member's name or ID is not currently supported.
...
| Name         | Description    | Default Value |
|--------------|----------------|---------------|
| &#8209;&#8209;name                                | Name to be used for this  locator service. If not specified, gfsh generates a random name. | |
...
| &#8209;&#8209;locators                            | List of locators used by this locator to join the appropriate  cluster. | |
...
| &#8209;&#8209;mcast-address                       | IP address or hostname used to bind the UPD socket for multi-cast networking so the locator can locate other members in the  cluster. If mcast-port is zero, then mcast-address is ignored. | |
| &#8209;&#8209;mcast-port                          | Port used for multi-cast networking so the locator can locate other members of the  cluster. A zero value disables mcast. | |
...
| &#8209;&#8209;enable-time-statistics          | Causes additional time-based statistics to be gathered for  operations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | true |
...
| &#8209;&#8209;locators                        | Sets the list of locators used by the Cache Server to join the appropriate  cluster.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | |
...
| &#8209;&#8209;mcast-address                   | The IP address or hostname used to bind the UDP socket for multi-cast networking so the Cache Server can locate other members in the  cluster. If mcast-port is zero, then mcast-address is ignored.                                                                                                                                                                                                                                                                                                                                                                                                     | |
| &#8209;&#8209;mcast-port                      | Sets the port used for multi-cast networking so the Cache Server can locate other members of the  cluster. A zero value disables mcast.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | |
...
| &#8209;&#8209;initial-heap                    | Initial size of the heap in the same format as the JVM -Xms parameter.<p><b>Note:</b> If you use the `--J=-Xms` and `--J=-Xmx` JVM properties instead of `--initial-heap` and `--max-heap`, then  does not use default JVM resource management properties. If you use the JVM properties, you must then specify all properties manually for eviction, garbage collection, heap percentage, and so forth.</p>                                                                                                                                                                                             | |
