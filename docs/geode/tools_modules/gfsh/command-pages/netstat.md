...
| <span class="keyword parmname">&#8209;&#8209;group</span>     | Group of members on which to run the `netstat` command.                                                                                                   | Â              |
| <span class="keyword parmname">&#8209;&#8209;file</span>      | Text file to which output from the `netstat` command will be written. A "`.txt`" extension will be added if it is not already part of the specified name. | Â              |
