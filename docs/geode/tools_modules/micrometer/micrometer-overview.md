...
@@product_name@@ uses [Micrometer](https://micrometer.io) to provide an interface for emitting user focused metrics, instrumented in code, to a variety of different consuming Application Performance Monitoring (APM) tools. @@product_name@@ has Micrometer instrumentation added to a subset of information available, which can be easily emitted from a Meter Registry.
