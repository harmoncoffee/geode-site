---
title: Geode Micrometer
sidebar_label: Geode Micrometer
sidebar_position: 1
---
...
-   **[Micrometer meters and tags](micrometer-meters.html)** Geode     contains a set of meters, instrumented statistics, that provide information about each individual member of a cluster. Every member within a Geode cluster will can emit a set of meters of different types, timer, gauge, and counters that are specific to the member.
