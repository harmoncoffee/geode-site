...
-   Some special formats of JSON documents are not supported in @@product_name@@ REST. See [Key Types and JSON Support](troubleshooting#concept_gsv_zd5_m4) for examples.
