...
This section summarizes all available  REST API resources and endpoints.

**Note:**
This documentation covers the **v1** release of  REST APIs for developing applications.
