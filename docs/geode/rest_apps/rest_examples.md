...
This section provides examples that illustrate how multiple clients, both REST and native, can access the same  region data.
...
## \#1a.  Cache Java Client (MyJavaClient.java)
