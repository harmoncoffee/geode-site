...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `eviction-algorithm` | `lru-heap-percentage`                                                                                                                                                                                                                                     |
| `eviction-action`    | `local-destroy` <br/><br/>**Note:** Normally, `local-destroy` cannot be used with replicated regions. However, `REPLICATE_HEAP_LRU` is different: it is preloaded and stays in sync by registering interest in the keys of its peers’ replicated regions. |
