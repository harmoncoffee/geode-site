...
sidebar_label: Where to Place Security Configuration Settings
sidebar_position: 4
---
...
Upon startup,  processes will look for the `gfsecurity.properties` file in the following locations in order:
